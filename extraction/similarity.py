...
'''
    similarity - this code provides a tool to query text by vector closeness i.e. semantic similarity using Word2Vec
        Procedure:
            - initialize Word2Vec model and preprocess text documents
            - obtain vector representation of query text
            - obtain vector representation of text document sentences
            - compute cosine similarity between query vector and text document vector]
